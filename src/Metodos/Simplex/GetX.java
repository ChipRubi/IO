...
package Metodos.Simplex;

import static View.Simplex.GuiSimplex.jtaOperaciones;
...
public class GetX {
    ...
    public static void mostar(DefaultTableModel modeloSolucion,int Xn){
        ...
        jtaOperaciones.setText("Resultados:\n\n");
        String xn;
        for (int n = 1; n <= Xn; n++) {
            xn = "X"+n;
        ...
        jtaOperaciones.append(" Z = "+String.valueOf(modeloSolucion.getValueAt(fil-2,col-2 )));        
    }
